...
export default function FrontCard() {
    ...
    return (
        <section className="credit-card flex flex-col justify-between rounded-xl p-2 shadow-lg w-[280px] h-[176px] bg-gradient-to-r from-neutral-600 to-neutral-950">
            {brand}
            ...
            <div className="grid grid-cols-2 text-xs md:text-sm overflow-hidden text-white">
                ...
                <label htmlFor="expires" className="text-end">
